...
####      Output settings     ####
##################################
scenario_name= "Egmond_beach_nourishments"
...
##################################
    ...
    V_trend_std=0
    scenario_list = ["B"] #choose which types of nourishments are simulated B=Beach, N=Nearshore, M=Mega, E=Erosion (no nourishments)
